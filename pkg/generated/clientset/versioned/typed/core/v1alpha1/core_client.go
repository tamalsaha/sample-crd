...
import (
	v1alpha1 "github.com/tamalsaha/sample-crd/apis/core/v1alpha1"
	"github.com/tamalsaha/sample-crd/pkg/generated/clientset/versioned/scheme"
...
// CoreV1alpha1Client is used to interact with features provided by the core.example.com group.
type CoreV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CoreV1alpha1Client) Apps(namespace string) AppInterface {
