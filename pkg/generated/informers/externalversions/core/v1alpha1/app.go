...
import (
	...
	versioned "github.com/tamalsaha/sample-crd/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/tamalsaha/sample-crd/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/tamalsaha/sample-crd/pkg/generated/listers/core/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha1().Apps(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha1().Apps(namespace).Watch(context.TODO(), options)
			},
		},
		&corev1alpha1.App{},
		resyncPeriod,
...
func (f *appInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1alpha1.App{}, f.defaultInformer)
}
